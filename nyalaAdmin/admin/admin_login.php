		...
		<section class="form-container" id="admin_login">
			<form action="" method="post">
				...
				<div class="input-field">
					<label>User email <sup>*</sup></label><br>
					<input type="text" name="name" maxlength="20" required placeholder="Enter your user email" oninput="this.value.replace(/\s/g,'')">
				</div>
				<div class="input-field">
				...
				<input type="submit" name="register" value="login now" class="btn">
			</form>
		</section>
	</div>
</body>
