...
<meta name="viewport" content="width=device-width, initial-scale=1.0">
	...
	<title>Nyala Candle | checkout </title>
</head>
<body>
                			...
                			<div class="box">
                				...
                				<div class="input-field">
                					...
                					<select name="method" class="input">
                						...
                						<option value="credit or debit card">Paypal</option>
                					</select>
                				</div>
                				<div class="input-field">
                			...
                			<?php 
                				...
                				if (isset($_GET['get_id'])) {
                					...
                					while($fetch_get = $select_get->fetch(PDO::FETCH_ASSOC)){
                						...
                						$grand_total = $grand_total + (int)$sub_total;
									}
                					
                			?>
                			<div class="flex">
    <?php if ($select_get->rowCount() > 0): ?>
        <?php while ($fetch_get = $select_get->fetch(PDO::FETCH_ASSOC)): ?>
        ...
        <?php endwhile; ?>
    <?php else: ?>
        <!-- Display some message or handle the case when no results are found -->
