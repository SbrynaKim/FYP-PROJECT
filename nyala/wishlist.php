...
<head>
	...
	<title>Nyala Candle | wishlist </title>
</head>
<body>
	...
	<div class="main">
		...
		<section class="products">
			...
			<div class="box-container">
				...
				<?php 
				if (!is_numeric($fetch_wishlist['price'])) {
					if (is_string($fetch_wishlist['price'])) {
						$fetch_wishlist['price'] = floatval($fetch_wishlist['price']);
					} else {
